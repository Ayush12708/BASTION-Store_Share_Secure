...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-$ryr_937))lwjgtp=0!5euve)-+g)r5p7zm=)qlk!u8gn!**gk')
...
AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME', "myvault12708")
